...
function ml_setting_show_editor_callback() {
    echo '<input name="ml_setting_show_editor" id="ml_setting_show_editor" type="checkbox" value="1" class="code"' . checked( 1,get_option('ml_setting_show_editor'), false ) . '/>Choose if details should be an editor';
}

function ml_setting_show_media_buttons_callback() {
    echo '<input name="ml_setting_show_media_buttons" id="ml_setting_show_media_buttons" type="checkbox" value="1" class="code"' . checked( 1,get_option('ml_setting_show_media_buttons'), false ) . '/>Choose if media buttons should be enabled';
}
?>