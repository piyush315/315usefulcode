        ...
        <div class="wrap todo-form">
            <div class="form-group">
                ...
                <select name="priority" id="priority">
                    <?php
                        $option_value = array( 'Low','Normal','High' );
                        foreach( $option_value as $key => $value ) {
                            if ($value == $mtl_todo_stored__meta['priority'][0]) {
                                ?>
            ...
            <div class="form-group">
                ...
                <input type="date" name="due_date" id="due_date" value="<?php if( ! empty( $mtl_todo_stored__meta['due_date'] ) ) echo esc_attr( $mtl_todo_stored__meta['due_date'][0] );?>"/>
            </div>
