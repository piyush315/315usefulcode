...
public function __construct() {
    parent::__construct(
        ...
        array( 'description' => esc_html__( 'Outputs social icons linked to profile', 'sl_domain' ), ) // Args
    );
}
...
public function getForm( $instance ) {
        ...
        if ( isset ( $instance['google_link'] ) ) {
            ...
            $google_link = 'http://plugs.google.com/';
        }
        ...
        <h4>Facebook</h4>
        <p><label for="<?php echo $this->get_field_id('facebook_link'); ?>"><?php _e('Link');?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('facebook_icon'); ?>"><?php _e('Icon');?></label>
        ...
        <h4>Twitter</h4>
        <p><label for="<?php echo $this->get_field_id('twitter_link'); ?>"><?php _e('Link');?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('twitter_link'); ?>"><?php _e('Icon');?></label>
        ...
        <h4>LinkedIn</h4>
        <p><label for="<?php echo $this->get_field_id('linkedin_link'); ?>"><?php _e('Link');?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('linkedin_icon'); ?>"><?php _e('Icon');?></label>
        ...
        <h4>Google+</h4>
        <p><label for="<?php echo $this->get_field_id('google_link'); ?>"><?php _e('Link');?></label>
        ...
        <p><label for="<?php echo $this->get_field_id('google_icon'); ?>"><?php _e('Icon');?></label>
        ...
        <p for="<?php echo $this->get_field_id( 'icon_width' );?>"><?php _e('Icon Width:')?></p>
 ...
 * @param array $icon_width width of Icon
 */
